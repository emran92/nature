...
@section('content')
    ...
    <div class="col-md-9 col-lg-9">
        <h4 class="p-title mt-30"><b>CONTACT US</b></h4>
        <div class="row">
            ...
            <div class="col-md-3 text-center">
                <ul class="list-unstyled mb-0">
                    <li><i class="fa fa-map-marker fa-2x text-primary"></i>
                    ...
                    <li><i class="fa fa-envelope mt-4 fa-2x text-warning"></i>
                        <p>contact@nature.com</p>
                    </li>
                </ul>
            </div>
        </div>
